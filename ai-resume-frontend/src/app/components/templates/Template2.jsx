  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full p-7 flex flex-col box-border">
        ...
        {/* Main grid */}
        <div className="mt-4 grid grid-cols-[240px_1fr] gap-6 flex-1 min-h-0">
          {/* Left column */}
          <aside className="flex flex-col gap-3 z-10">
            {/* CONTACT */}
            <section className="bg-gray-50 border border-gray-100 rounded-md p-3">
            ...
            {/* EDUCATION */}
            <section className="bg-white border border-gray-100 rounded-md p-3">
          ...
          <main className="flex flex-col gap-3 min-h-0">
            ...
            {/* EXPERIENCE */}
            <section className="bg-white border border-gray-100 rounded-md p-3 flex-1 min-h-0 overflow-hidden">
        ...
        {/* Footer */}
        <div className="mt-3 pt-2 border-t border-gray-100 text-center text-xs text-gray-400">Generated · Modern Corporate · One page</div>
      </div>
    </div>
  );
}
